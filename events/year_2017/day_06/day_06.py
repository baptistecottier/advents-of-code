"""
Advent of Code - Year 2017 - Day 6
...
def solver(state: list[int]) -> tuple[int, int]:
    """
    ...
    cycles = len(visited)
    return cycles, cycles - visited.index(last)


def redistributions(bank: list[int]) -> tuple[list, list[int]]:
    """
