...
The Elves have sent you some **Amplifier Controller Software** (your puzzle input), a program that should run on your [existing Intcode computer](../05/README.md#day-5-sunny-with-a-chance-of-asteroids). Each amplifier will need to run a copy of the program.
